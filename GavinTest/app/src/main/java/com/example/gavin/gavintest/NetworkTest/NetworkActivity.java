package com.example.gavin.gavintest.NetworkTest;
...
//                            "\t</app>\n" +
//                            "</apps>";
                    String responseData = "[{\"id\":\"5\",\"version\":\"5.5\",\"name\":\"Clash of Clans\"},\n" +
    ...
    private void parseJSONWithJSONObject(String jsonData) {
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                Log.d("NetworkActivity", "parseJSONWithJSONObject id is " + id);
                Log.d("NetworkActivity", "parseJSONWithJSONObject name is " + name);
                Log.d("NetworkActivity", "parseJSONWithJSONObject version is " + version);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
