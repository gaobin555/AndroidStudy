...
public class DigitalConvert {
	 ...
	 * bytes字符串转换为Byte值
	 *
	 * @param hexString hexString Byte字符串，每个Byte之间没有分隔符
	 * @return byte[]
	 */
	...
	public static String[] combineString(String[] arr1, String[] arr2) {
		if (arr1 == null) {
			Log.i("combineString", "arr1 == null, return arr2");
			return arr2;
		}
		if (arr2 == null) {
			Log.i("combineString", "arr2 == null, return arr1");
			return arr1;
		}
        String[]  arr3 = new String[arr1.length + arr2.length];
        System.arraycopy(arr1, 0, arr3, 0, arr1.length);
        System.arraycopy(arr2, 0, arr3,  arr1.length, arr2.length);
        Log.i("combineString", "combineString length = " + arr3.length);
		return arr3;
    }
}