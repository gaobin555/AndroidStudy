...
public class JvWeChatContainerView extends LinearLayout {
    ...
    public JvWeChatContainerView(Context context) {
        this(context, null);
    }

    public JvWeChatContainerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public JvWeChatContainerView(Context context, AttributeSet attrs, int defStyleAttr) {
