...
public class WheelView extends ListView implements ListView.OnScrollListener, View.OnTouchListener,
    ...
    public static final int SECTION_DELAY = 100;//ms
    ...
    private void _setItems(List<?> list) {
    ...
    public void setItems(List<?> list, int index) {
        _setItems(list);
        setSelectedIndex(index);
    }

    public void setItems(List<?> list, Object item) {
        _setItems(list);
        setSelectedItem(item);
    }

    public void setItems(Object[] list, int index) {
        setItems(Arrays.asList(list), index);
    }

    public void setItems(Object[] list, Object item) {
    ...
    public interface OnWheelListener {
         ...
         * @param item         当前选择项的值
         */
        void onSelected(boolean isUserScroll, int index, Object item);
    }
    ...
    private static class ItemView extends LinearLayout {
        ...
        private void init(Context context) {
            ...
            int paddingTopBottom = DensityUtil.dipToPx(context, ITEM_PADDING_TOP_BOTTOM);
            int paddingLeftRight = DensityUtil.dipToPx(context, ITEM_PADDING_LEFT_RIGHT);
            setPadding(paddingLeftRight, paddingTopBottom, paddingLeftRight, paddingTopBottom);
            setGravity(Gravity.CENTER);
            int height = DensityUtil.dipToPx(context, ITEM_HEIGHT);
            ...
            imageParams.rightMargin = DensityUtil.dipToPx(context, ITEM_MARGIN);
    ...
    private static class WheelAdapter extends BaseAdapter {
        ...
        public final WheelAdapter setData(List<?> list) {
            data.clear();
            if (null != list) {
                data.addAll(list);
            }
