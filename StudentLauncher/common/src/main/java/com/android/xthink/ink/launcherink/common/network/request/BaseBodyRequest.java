...
public abstract class BaseBodyRequest<R extends BaseBodyRequest> extends BaseRequest<R> implements HasBody<R> {
    ...
    @SuppressWarnings("unchecked")
    @Override
    public R upJson(@Nullable JSONObject jsonObject) {
        if (jsonObject != null) {
    ...
    @SuppressWarnings("unchecked")
    @Override
    public R upJson(@Nullable JSONArray jsonArray) {
        if (jsonArray != null) {
    ...
    public RequestBody generateRequestBody() {
        ...
        return InkHttpUtils.generateMultipartRequestBody(params, isMultipart);
    }
}