...
public class JvWeakHandlerNew {
         ...
         */
        public JvWeakHandlerNew(@Nullable Handler.Callback callback) {
         ...
         */
        public JvWeakHandlerNew(@NonNull Looper looper) {
            mCallback = null;
         ...
         * @param callback The callback interface in which to handle messages, or null.
         */
        public JvWeakHandlerNew(@NonNull Looper looper, @NonNull Handler.Callback callback) {
            mCallback = callback;
