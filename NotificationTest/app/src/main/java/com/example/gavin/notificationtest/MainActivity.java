package com.example.gavin.notificationtest;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.send_notic:
                Intent intent = new Intent(this, NotifcationAction.class);
...
//                        .setContentText("This is content text")
                        ...
                        .setStyle(new NotificationCompat.BigTextStyle().bigText("Learn how to build " +
                                "notification, send and sync data, and use voice action. Get the official " +
